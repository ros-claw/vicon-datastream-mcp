...
属于 [ROSClaw](https://github.com/ros-claw) 具身智能操作系统。
...
│   └── mcp_server.py            # 主 MCP Server (81KB, 完整实现)
├── prompts/                     # 提示词模板
│   ├── system.txt               # 系统提示词
│   └── examples/                # 示例提示词
│       └── basic_usage.txt
...
| 属性 | 值 |
|------|-------|
| **SDK 名称** | Vicon DataStream SDK |
| **SDK 版本** | 1.12.145507h |
| **协议** | TCP / Multicast |
| **文档** | [SDK 手册](./docs/Vicon%20DataStream%20SDK%20Manual.pdf) |
| **许可证** | Vicon 专有许可证 |

## 属于 ROSClaw

- [rosclaw](https://github.com/ros-claw/rosclaw) — 核心框架
- [vicon-datastream-mcp](https://github.com/ros-claw/vicon-datastream-mcp) — 本仓库
...
*SDK: Vicon DataStream SDK v1.12.145507h | 协议: TCP/Multicast*
